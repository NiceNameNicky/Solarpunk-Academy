...
public class InputManager : MonoBehaviour
{
    ...
    public void PPressed(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            pPressed = true;
    ...
    public bool GetOnePressed()
    {
        bool result = onePressed;
        onePressed = false;
        return result;
    }

    public bool GetTwoPressed()
    {
        bool result = twoPressed;
        twoPressed = false;
        return result;
    }
